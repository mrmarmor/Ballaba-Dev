...
public class PropertyAttachment {
    ...
    public enum Type /*implements Serializable*/ {
        ...
        /*TODO missing icon*/GUARD(7, R.string.attach_guard, R.drawable.parking_blue_36),
        /*TODO missing icon*/BARS(8, R.string.attach_bars, R.drawable.parking_blue_36),
        /*TODO missing icon*/WAREHOUSE(9, R.string.attach_warehouse, R.drawable.parking_blue_36),
        /*TODO missing icon*/SUN_TERRACE(10, R.string.attach_sunterrace, R.drawable.parking_blue_36),
        /*TODO missing icon*/SERVICE_BALCONY(11, R.string.attach_service_balcony, R.drawable.parking_blue_36),
        /*TODO missing icon*/GARDEN(12, R.string.attach_garden, R.drawable.parking_blue_36),
        POOL(13, R.string.attach_pool, R.drawable.pool_blue_36),
        /*TODO missing icon*/ANIMALS(14, R.string.attach_animals, R.drawable.parking_blue_36),
        /*TODO missing icon*/FLOOR_HEAT(15, R.string.attach_floor_heat, R.drawable.parking_blue_36),
        /*TODO missing icon*/ALL_INCLUDED(16, R.string.attach_all_included, R.drawable.parking_blue_36),
