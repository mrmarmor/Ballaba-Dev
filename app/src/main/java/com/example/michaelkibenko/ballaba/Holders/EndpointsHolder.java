...
public @interface EndpointsHolder {
    ...
    //String PROPERTY_ATTACHMENTS_ADDONS = "https://api.ballaba-it.com/v1/config/properties";
    ...
    String GET_SAVED = "https://api.ballaba-it.com/v1/properties/saved";
    ...
    String UPLOAD_METTINGS_DATES = "https://api.ballaba-it.com/v1/properties/";
